...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
  //By looking at the variable name you can determine what type of data type it will be. For
  //a name is always going to be a string because it is using the alphabet. A statement
  //like isHungry has to be a boolean because it is either true or false.
  //Lastly numberOfPets is obviously going to be an integer.
